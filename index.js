import { breakfasts, mainDishes, westerns, addOns, beverages, desserts } from "./data.js"

const foods = breakfasts.concat(mainDishes, westerns, addOns, beverages, desserts)
let orderedItemArr = []
...
function completePayment(){
    ...
    document.getElementById('message').innerHTML = `
       Thanks, <span class="name">${document.getElementById('name-input').value}</span>! Your order is on its way!
    `
}
